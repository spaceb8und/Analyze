...
namespace Kurs
{
    ...
    public class Patient : Person
    {
        ...
        {
            if (severityDisease >= 0 &&
                severityDisease <= 10) // если степень тяжести заболевания не выходит за рамки (0..10)
            {
    ...
    public class Polyclinic : IAction
    {
        ...
        public void appointmentTherapist(Patient patient) // запись к терапевту
        {
            ...
            {
                Console.WriteLine(
                    $"На данный момент нет возможности для записи к терапевту для пациента: {patient.Name}");
            }
        }
        ...
        public void appointmentPediatrician(Patient patient) // запись к педиатру
        {
            ...
            {
                Console.WriteLine(
                    $"На данный момент нет возможности для записи к педиатру для пациента: {patient.Name}");
            }
        }
        ...
        public void appointmentOptometrist(Patient patient)
        {
            ...
            {
                Console.WriteLine(
                    $"На данный момент нет возможности для записи к окулисту для пациента: {patient.Name}");
            }
        }
        ...
        public void appointmentTraumatologist(Patient patient) // запись к травматологу
        {
            ...
            {
                Console.WriteLine(
                    $"На данный момент нет возможности для записи к травматологу для пациента: {patient.Name}");
            }
        }
        ...
        public void appointmentPsychiatrist(Patient patient) // запись к психотерапевту
        {
            ...
            {
                Console.WriteLine(
                    $"На данный момент нет возможности для записи к психиатру для пациента: {patient.Name}");
            }
        }
