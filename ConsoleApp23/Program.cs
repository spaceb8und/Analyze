...
namespace Utils
{
    ...
    public class Test
    {
        public static void Main()
        {
            ...
            string message = Console.ReadLine(); // Input string
            string messageRev = Utils.Reverse(message); // reverse string
            Console.WriteLine("String after reverse: {0}", messageRev); // output
